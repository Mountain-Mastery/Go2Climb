...
namespace Go2Climb.API.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            var resources = _mapper.Map<IEnumerable<Customer.API.Domain.model.Customer>, IEnumerable<CustomerResource>>(customers);
            return Ok(resources);
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            var resources = _mapper.Map<Customer.API.Domain.model.Customer, CustomerResource>(customer);
            return Ok(resources);
        }
